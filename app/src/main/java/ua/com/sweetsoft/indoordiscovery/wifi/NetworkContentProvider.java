...
public class NetworkContentProvider extends ContentProvider
{
    ...
    public static final Uri NETWORKS_URI = Uri.withAppendedPath(AUTHORITY_URI, PATH);
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values)
    {
        ...
        if (m_uriMatcher.match(uri) == URI)
        {
            if (m_databaseHelper.openForWrite())
            {
                ...
                resultUri = ContentUris.withAppendedId(NETWORKS_URI, rowId);
                m_databaseHelper.close();
    ...
    {
        m_databaseHelper = new NetworkDatabaseHelper(getContext());
        return true;
    }
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder)
    {
        ...
        if (m_databaseHelper.openForRead())
        {
            ...
            if (cursor != null)
            {
                ...
                if (context != null)
                {
                    cursor.setNotificationUri(context.getContentResolver(), NETWORKS_URI);
                }
            }
        }
        return cursor;
